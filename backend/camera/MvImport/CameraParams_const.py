...
MV_GIGE_DEVICE = (
    0x00000001  # < \~chinese GigE设备                     \~english GigE Device
)
MV_1394_DEVICE = (
    0x00000002  # < \~chinese 1394-a/b 设备                \~english 1394-a/b Device
)
MV_USB_DEVICE = (
    0x00000004  # < \~chinese USB 设备                     \~english USB Device
)
...
MV_GENTL_XOF_DEVICE = (
    0x00000200  # < \~chinese XoF设备                   \~english GenTL XoF Device
)
...
MV_XOF_INTERFACE = (
    0x00000010  # < \~chinese XoFLink采集卡            \~english XoFLink interface
)
